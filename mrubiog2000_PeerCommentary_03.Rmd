---
title: "mrubiog2000_PeerCommentary_aer13_03"
...
```
##Abby: I like that you used the grid extra function! It makes it very easy to visualize the data 
...
###Abby: You can use color = factor(gender) to color datapoints by gender 
...
```
##Abby: I used 1.96 for both my upper and lower in the Poisson function, but I am not sure which is right 
...
##Abby: I did a separate loop for each variable, here is my code
set <- NULL
...
###Abby: really goob job! I thought your code was very clear, and using gridExtra made it very easy to read your graphs 
